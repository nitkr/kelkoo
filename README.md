...
Personal Android music app (sideload APK). Fork of [Echo Music](https://github.com/EchoMusicApp/Echo-Music) (GPL-3.0).
See `LICENSE` and `NOTICE` for licensing and attribution.
