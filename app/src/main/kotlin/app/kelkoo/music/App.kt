...
class App : Application(), SingletonImageLoader.Factory {
    ...
    override fun onCreate() {
        ...
        app.kelkoo.music.utils.cipher.CipherDeobfuscator.initialize(this)
    ...
    private suspend fun initializeSettings() {
        ...
        val engineName = settings[app.kelkoo.music.constants.PlaybackEngineKey]
        app.kelkoo.music.utils.YTPlayerUtils.playbackEngine = try {
            if (engineName != null) app.kelkoo.music.constants.PlaybackEngine.valueOf(engineName)
            else app.kelkoo.music.constants.PlaybackEngine.AUTO
        } catch (_: Exception) { app.kelkoo.music.constants.PlaybackEngine.AUTO }
    ...
    private fun observeSettingsChanges() {
        ...
        app.kelkoo.music.utils.lastfm.LastFM.initialize(
