...
package app.kelkoo.music.listentogether
...
import app.kelkoo.music.constants.ListenTogetherAutoApprovalKey
import app.kelkoo.music.constants.ListenTogetherIsHostKey
import app.kelkoo.music.constants.ListenTogetherRoomCodeKey
import app.kelkoo.music.constants.ListenTogetherServerUrlKey
import app.kelkoo.music.constants.ListenTogetherSessionTimestampKey
import app.kelkoo.music.constants.ListenTogetherSessionTokenKey
import app.kelkoo.music.constants.ListenTogetherUserIdKey
...
class ListenTogetherClient @Inject constructor(
    ...
    companion object {
        ...
        const val ACTION_APPROVE_JOIN = "app.kelkoo.music.LISTEN_TOGETHER_APPROVE_JOIN"
        const val ACTION_REJECT_JOIN = "app.kelkoo.music.LISTEN_TOGETHER_REJECT_JOIN"
        const val ACTION_APPROVE_SUGGESTION = "app.kelkoo.music.LISTEN_TOGETHER_APPROVE_SUGGESTION"
        const val ACTION_REJECT_SUGGESTION = "app.kelkoo.music.LISTEN_TOGETHER_REJECT_SUGGESTION"
    ...
    private fun loadBlockedUsernames() {
        try {
            val blockedJson = context.dataStore.get(app.kelkoo.music.constants.ListenTogetherBlockedUsersKey, "")
    ...
    private suspend fun saveBlockedUsernames() {
        try {
            ...
            context.dataStore.edit { preferences ->
                preferences[app.kelkoo.music.constants.ListenTogetherBlockedUsersKey] = blockedJson
            }
        } catch (e: Exception) {
