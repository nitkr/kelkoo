...
class MusicWidgetReceiver : AppWidgetProvider() {
    ...
    companion object {
        const val ACTION_PLAY_PAUSE = "app.kelkoo.music.widget.PLAY_PAUSE"
        const val ACTION_LIKE = "app.kelkoo.music.widget.LIKE"
        const val ACTION_NEXT = "app.kelkoo.music.widget.NEXT"
        const val ACTION_PREVIOUS = "app.kelkoo.music.widget.PREVIOUS"
        const val ACTION_UPDATE_WIDGET = "app.kelkoo.music.widget.UPDATE_WIDGET"
    }
}
