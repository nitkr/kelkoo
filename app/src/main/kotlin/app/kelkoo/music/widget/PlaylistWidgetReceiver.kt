...
class PlaylistWidgetReceiver : AppWidgetProvider() {
    ...
    private fun openTargetInApp(context: Context, source: Intent) {
        val activityIntent = Intent(context, MainActivity::class.java).apply {
            action = "app.kelkoo.music.action.OPEN_WIDGET_TARGET"
    ...
    companion object {
        ...
        const val ACTION_PLAY_TARGET = "app.kelkoo.music.widget.playlists.PLAY_TARGET"
        const val ACTION_UPDATE_WIDGET = "app.kelkoo.music.widget.playlists.UPDATE_WIDGET"
