...
package app.kelkoo.music.widget
...
import app.kelkoo.music.recognition.MusicRecognitionService
import app.kelkoo.music.widget.MusicRecognizerWidgetService.Companion.ALBUM_ART_CACHE_FILE
import app.kelkoo.music.widget.MusicRecognizerWidgetService.Companion.PREF_ARTIST_NAME
import app.kelkoo.music.widget.MusicRecognizerWidgetService.Companion.PREF_COVER_ART_PATH
import app.kelkoo.music.widget.MusicRecognizerWidgetService.Companion.PREF_ERROR_MESSAGE
import app.kelkoo.music.widget.MusicRecognizerWidgetService.Companion.PREF_PULSE_FRAME
import app.kelkoo.music.widget.MusicRecognizerWidgetService.Companion.PREF_SONG_TITLE
import app.kelkoo.music.widget.MusicRecognizerWidgetService.Companion.PREF_STATE
import app.kelkoo.music.widget.MusicRecognizerWidgetService.Companion.PREFS_NAME
import app.kelkoo.music.widget.MusicRecognizerWidgetService.Companion.STATE_ERROR
import app.kelkoo.music.widget.MusicRecognizerWidgetService.Companion.STATE_IDLE
import app.kelkoo.music.widget.MusicRecognizerWidgetService.Companion.STATE_LISTENING
import app.kelkoo.music.widget.MusicRecognizerWidgetService.Companion.STATE_NO_MATCH
import app.kelkoo.music.widget.MusicRecognizerWidgetService.Companion.STATE_PROCESSING
import app.kelkoo.music.widget.MusicRecognizerWidgetService.Companion.STATE_SUCCESS
import java.io.File
...
class MusicRecognizerWidgetReceiver : AppWidgetProvider() {
        ...
        if (!MusicRecognitionService.hasRecordPermission(context)) {
            context.startActivity(
                Intent(context, MainActivity::class.java).apply {
                    action = "app.kelkoo.music.action.RECOGNITION"
    ...
    companion object {
        const val ACTION_START_RECOGNITION = "app.kelkoo.music.widget.recognizer.TAP_MIC"
        const val ACTION_UPDATE_WIDGET = "app.kelkoo.music.widget.recognizer.UPDATE"
        const val ACTION_RESET_STATE = "app.kelkoo.music.widget.recognizer.RESET"
    }
}
