...
class TurntableWidgetReceiver : AppWidgetProvider() {
    ...
    companion object {
        const val ACTION_TURNTABLE_PLAY_PAUSE = "app.kelkoo.music.widget.TURNTABLE_PLAY_PAUSE"
        const val ACTION_TURNTABLE_NEXT = "app.kelkoo.music.widget.TURNTABLE_NEXT"
        const val ACTION_TURNTABLE_PREVIOUS = "app.kelkoo.music.widget.TURNTABLE_PREVIOUS"
        const val ACTION_UPDATE_TURNTABLE_WIDGET = "app.kelkoo.music.widget.UPDATE_TURNTABLE_WIDGET"
    }
}
