...
import app.kelkoo.music.utils.PlaybackLogLevel
...
import app.kelkoo.music.utils.cipher.CipherDeobfuscator
import app.kelkoo.music.utils.YTPlayerUtils.MAIN_CLIENT
import app.kelkoo.music.utils.YTPlayerUtils.STREAM_FALLBACK_CLIENTS
import app.kelkoo.music.utils.YTPlayerUtils.validateStatus
import app.kelkoo.music.utils.potoken.PoTokenGenerator
import app.kelkoo.music.utils.potoken.PoTokenResult
import app.kelkoo.music.utils.sabr.EjsNTransformSolver
...
object YTPlayerUtils {
     ...
     */
    @Volatile
    var playbackEngine: app.kelkoo.music.constants.PlaybackEngine = app.kelkoo.music.constants.PlaybackEngine.AUTO
    ...
    private suspend fun findUrlOrNull(
        ...
        val useCipher = engine == app.kelkoo.music.constants.PlaybackEngine.POTOKEN || engine == app.kelkoo.music.constants.PlaybackEngine.AUTO
        if (useCipher) {
        ...
        val useBravePipe = engine == app.kelkoo.music.constants.PlaybackEngine.BRAVEPIPE || engine == app.kelkoo.music.constants.PlaybackEngine.AUTO
        if (useBravePipe) {
            if (skipNewPipe) {
