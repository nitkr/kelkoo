...
import app.kelkoo.music.utils.enumPreference
...
constructor(
    ...
    private val downloadQuality by enumPreference(context, app.kelkoo.music.constants.DownloadQualityKey, app.kelkoo.music.constants.DownloadQuality.YOUTUBE)
        ...
        ResolvingDataSource.Factory(
            ...
            val playbackData = runBlocking(Dispatchers.IO) {
                YTPlayerUtils.playerResponseForPlayback(
                    videoId = mediaId,
                    audioQuality = app.kelkoo.music.constants.AudioQuality.OPUS,
