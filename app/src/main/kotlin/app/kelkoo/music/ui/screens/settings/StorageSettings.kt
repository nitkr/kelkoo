...
import app.kelkoo.music.constants.MaxImageCacheSizeKey
...
import app.kelkoo.music.ui.utils.formatFileSize
        ...
        ActionPromptDialog(
            ...
            onConfirm = {
                androidx.media3.exoplayer.offline.DownloadService.sendRemoveAllDownloads(
                    context,
                    app.kelkoo.music.playback.ExoDownloadService::class.java,
                    false
                )
