...
import app.kelkoo.music.constants.PureBlackMiniPlayerKey
...
import app.kelkoo.music.listentogether.ListenTogetherManager
import app.kelkoo.music.models.MediaMetadata
import app.kelkoo.music.playback.CastConnectionHandler
import app.kelkoo.music.playback.PlayerConnection
import app.kelkoo.music.ui.screens.settings.DarkMode
import app.kelkoo.music.ui.component.GlassComponent
import app.kelkoo.music.ui.component.LocalGlassEffectConfig
import app.kelkoo.music.ui.component.isGlassSupported
...
private fun FavoriteButton(
    ...
    Box(
        ...
        HeartBurstIcon(
            isLiked = isLiked,
            iconSize = 20.dp,
            unlikedColor = onSurfaceColor.copy(alpha = 0.7f)
        )
    }
}
@Composable
