...
import app.kelkoo.music.updater.saveAutoUpdateCheckSetting
...
import app.kelkoo.music.updater.saveUpdateNotificationsSetting
import android.widget.Toast
import androidx.compose.ui.res.pluralStringResource
import app.kelkoo.music.updater.getDownloadedApkCount
import app.kelkoo.music.updater.clearDownloadedApks
import app.kelkoo.music.updater.getBetaUpdatesSetting
import app.kelkoo.music.updater.saveBetaUpdatesSetting
import app.kelkoo.music.updater.autoClearOldApks
...
fun UpdateSettings(
    ...
    isHighlighted = (highlightKey == stringResource(R.string.system_update)),
                    ...
                    onClick = {
                        val intent = Intent(Intent.ACTION_VIEW, Uri.parse("https://github.com/nitkr/kelkoo/releases"))
